...
extern void read_tipsy_file_parallel(vector<real4> &bodyPositions, vector<real4> &bodyVelocities, vector<real4> &bodyColors,
...
bool octree::addGalaxy(int galaxyID)
{
    ...
    read_tipsy_file_parallel(newGalaxy_pos, newGalaxy_vel, newGalaxy_col, newGalaxy_ids, 0, fileName, 
